  ...
  var p = new Promise(function(resolve, reject) {
    ...
    util.loopKeys(model._joins, function(joins, key) {
      if ((docToSave.hasOwnProperty(key) || (saveAll === true)) &&
        ...
        if (self[key] != null && self[key]._save) {
          savedModel[joins[key].model.getTabeName()] = true;
          if (saveAll === true) {
...
Document.prototype._onSavedBelongsTo = function(
  ...
  util.loopKeys(belongsToKeysSaved, function(joins, key) {
    ...
    if (self[key] != null) {
      ...
      if (self[key].__proto__._parents &&
          self[key].__proto__._parents._belongsTo[constructor.getTableName()] == null) {
